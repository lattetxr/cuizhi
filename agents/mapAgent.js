...
写作质量要求（务必遵守）：
- 使用规范、自然的书面中文，概念之间关系清晰，体现由浅入深的认知顺序。
- definition 用 60-120 字讲清「是什么、为什么重要、与相近概念的区别」，example 给一个具体、可感知的真实情境，而不是重复定义。
- learning_path 的 action 用 50-110 字写成可直接照做的步骤，包含做什么、怎么做、完成标准；duration 给出合理时间。
- misconceptions 至少 2 条，correction 用 50-110 字解释错在哪里、正确做法是什么以及可能后果，形成对照。
- application_scenarios 至少 2 个，practice 用 50-110 字给出完整操作指引，读者照着就能练习。
- 每条内容都应让零基础读者学到东西，禁止一两句空话或正确但无信息量的套话。
